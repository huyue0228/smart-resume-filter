...
CONTACTS = [
    {"序号": 1, "一层部门": "技术中心", "二层部门": "后端组", "姓名": "王工", "工号": "T001"},
    {"序号": 2, "一层部门": "产品中心", "二层部门": "产品组", "姓名": "李工", "工号": "P001"},
    {"序号": 3, "一层部门": "数据中心", "二层部门": "数据组", "姓名": "赵工", "工号": "D001"},
]

JOBS = [
    {"主体": "GW", "一层部门": "技术中心", "二层部门": "后端组", "岗位类别": "技术类",
     "对外发布名称": "后端开发", "是否对外发布": "是", "职位名称": "后端开发工程师",
     "岗位族": "研发", "工作地点": "北京", "学历": "硕士", "需求专业": "计算机、软件工程", "需求数量": 3},
    {"主体": "YLS", "一层部门": "产品中心", "二层部门": "产品组", "岗位类别": "产品类",
     "对外发布名称": "产品经理", "是否对外发布": "是", "职位名称": "产品经理",
     "岗位族": "产品", "工作地点": "上海", "学历": "本科", "需求专业": "不限", "需求数量": 2},
    {"主体": "GW", "一层部门": "数据中心", "二层部门": "数据组", "岗位类别": "技术类",
     "对外发布名称": "数据分析", "是否对外发布": "是", "职位名称": "数据分析师",
     "岗位族": "研发", "工作地点": "北京", "学历": "硕士", "需求专业": "统计学、数学", "需求数量": 2},
]

...
| ----- | ------- | ------------------------------------------------------------------------------------------------- |
| id    | PK      |                                                                                                   |
| key   | varchar | 如 ai_timeout_seconds、ai_dispatch_threshold、ai_review_threshold、ai_max_concurrency、ai_retry_count、ai_retry_backoff_seconds、ai_prompt_version、ai_decision_version、welink_enabled；应用层拦截重复 |
| value | jsonb   | 配置值                                                                                            |
